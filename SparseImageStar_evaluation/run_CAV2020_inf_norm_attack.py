...
def verify_convnet_network(net_type='Small', dtype='float32'):
    ...
    print(tabulate(data, headers=[f"", f"delta={epsilon[0]}", f"delta={epsilon[1]}", f"delta={epsilon[2]}"]))
    print()

    Tlatex = tabulate(data, headers=[f"", f"delta={epsilon[0]}", f"delta={epsilon[1]}", f"delta={epsilon[2]}"], tablefmt='latex')
    ...
    print(tabulate(data, headers=[f"", f"delta={epsilon[0]}", f"delta={epsilon[1]}", f"epsilon={epsilon[2]}"]))
    print()

    Tlatex = tabulate(data, headers=[f"", f"delta={epsilon[0]}", f"delta={epsilon[1]}", f"epsilon={epsilon[2]}"], tablefmt='latex')
