"""
Test util load module for satlin network
Yuntao Li, 2/6/2024
"""

from StarV.util import load_satlin
...
class Test(object):
    ...
    def test_tiny_network(self):
        ...
        try:
            [net, lb, ub, unsafe_mat, unsafe_vec] = load_satlin.load_tiny_network()
            net.info()
        except Exception:
            print('Test Fail!')
    ...
    def test_load_2017_IEEE_TNNLS(self):
        ...
        self.n_tests = self.n_tests + 1
        try:
            net = load_satlin.load_2017_IEEE_TNNLS()
            net.info()
        except Exception:
            print('Test Fail!')
            self.n_fails = self.n_fails + 1
    ...
    def test_load_ACASXU(self, x, y, spec_id):
        ...
        try:
            net, lb, ub, unsafe_mat, unsafe_vec = load_satlin.load_ACASXU(x,y,spec_id)
            net.info()
