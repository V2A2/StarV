...
def gru_certification_sparsestar():  
    type='gru'
    in_shape = 784
    num_seq = 2
    frame_size = in_shape // num_seq
...
if __name__ == "__main__":
    gru_rechability_sparsestar()
    gru_certification_sparsestar()