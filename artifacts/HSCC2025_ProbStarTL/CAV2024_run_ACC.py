...
def verify_temporal_specs_ACC():
    'verify temporal properties of Le-ACC, tables are generated and stored in artifacts/CAV2024/table'


    net='controller_5_20'
    plant='linear'
    #spec_ids = [0,1] # for testing
...
def analyze_timing_performance():
    ...
    figures are stored in artifacts/CAV2024/pics
...
def analyze_conservativeness():
    'analyze conservativeness of verification results, figures are generated and stored in artifacts/CAV2024/pics'
...
def analyze_verification_complexity():
    'analyze verification complexity, figures are generated and stored in artifacts/CAV2024/pics'
...
def analyze_verification_complexity_2():
    'produce a figure of n_CDNF_SAT and n_CDNF_UNSAT and store in artifacts/CAV2024/data'
...
def analyze_verification_complexity_3():
    'pictures are generated and stored in artifacts/CAV2024/pics'
