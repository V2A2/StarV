"""
Test util load module for satlins network
Yuntao Li, 2/6/2024
"""

from StarV.util import load_satlins
...
class Test(object):
    ...
    def test_tiny_network(self):
        ...
        try:
            [net, lb, ub, unsafe_mat, unsafe_vec] = load_satlins.load_tiny_network()
            net.info()
        except Exception:
            print('Test Fail!')
    ...
    def test_load_2017_IEEE_TNNLS(self):
        ...
        self.n_tests = self.n_tests + 1
        try:
            net = load_satlins.load_2017_IEEE_TNNLS()
            net.info()
        except Exception:
            print('Test Fail!')
            self.n_fails = self.n_fails + 1
    ...
    def test_load_ACASXU(self, x, y, spec_id):
        ...
        try:
            net, lb, ub, unsafe_mat, unsafe_vec = load_satlins.load_ACASXU(x,y,spec_id)
            net.info()
